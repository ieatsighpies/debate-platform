...
while human-to-AI persuasion dynamics are treated as exploratory and deferred to future work.
...
how AI systems influence human belief and confidence outcomes. The platform is also designed to capture
signals relevant to human-to-AI dynamics as a deferred extension. To conduct this investigation at scale and under controlled experimental conditions, we design,
...
while preserving data for future human-to-AI analysis.
...
\begin{enumerate}
    ...
    communicative styles influence AI-to-human persuasion in this thesis. Personality configurations are
    ...
    \end{itemize}
    This enables systematic analysis of participant stance evolution in this report: tracking how
    participants' initial positions shift across successive debate rounds and culminate in final stances.
    The same instrumentation also preserves AI-side traces for exploratory and future human-to-AI analysis.
