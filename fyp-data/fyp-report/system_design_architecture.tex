...
\begin{verbatim}
{
  ...
  player1Stance: String (for|against),
    player1StanceChoice: String(for|against|unsure)
                        (if user chooses unsure, they will
                        be randomly assigned for/against),
  ...
  player2Stance: String (for|against),
    player2StanceChoice: String(for|against|unsure)
                    (AI/unsure human opponents will be
                    assigned opposite of player1Stance),
  currentBelief: {
  ...
  preDebateSurvey: {
    player1: String(firm_on_stance|
              convinced_of_stance|open_to_change),
    player2: String(firm_on_stance|
              convinced_of_stance|open_to_change),
  },
  postDebateSurvey: {
    player1: String(strengthened|slightly_strengthened|
              no_effect|slightly_weakened|weakened),
    player2: String(strengthened|slightly_strengthened|
              no_effect|slightly_weakened|weakened),
    ...
    player1SuspicionTiming: String(round_1_2|round_3_4|round_5_7|
                                   round_8_12|round_13_17|
                                   round_18_20|never_suspected),
    player2SuspicionTiming: String(round_1_2|round_3_4|round_5_7|
                                   round_8_12|round_13_17|
                                   round_18_20|never_suspected),
    ...
    player1AiAwarenessEffect: String(no_difference|less_persuasive|
                                     more_persuasive|not_sure),
    player2AiAwarenessEffect: String(no_difference|less_persuasive|
                                     more_persuasive|not_sure),
...
\subsubsection{Guest Login and Resume Flow}

\begin{enumerate}
    \item User clicks guest login.
    \item Backend generates a unique username (e.g., "AdorableWolf").
    \item User document is created with \texttt{isGuest=true}.
    \item JWT token is generated (7-day expiration).
    \item Frontend returns guest accounts from the last 7 days.
